...
<div class="wrapper">
    ...
    <div class="page-content">
        <div class="content container">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-title">修改音乐<small> 上架新歌喽</small></h2>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="widget">
                        ...
                        <div class="widget-content">
                            <div class="body">
                                <form data-validate="parsley" method="post" action="/song/updateSong" novalidate="" class="form-horizontal label-left" id="song-form" >
                                    <input style="display: none" name="sid" value="${song.sid}"></input>

                                    <input style="display: none" name="pic" value="${song.pic}"></input>
                                    <input style="display: none" name="mp3" value="${song.mp3}"></input>
                                    <fieldset>
