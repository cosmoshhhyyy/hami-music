...
/*            $("[modify]").click(function () {
            ...
            $("[modify]").click(function () {
                var sid = $(this).attr("sid");
                window.location.href = "/song/getSong?sid=" + sid;
            });
                                ...
                                <table class="table table-striped table-images" style="color: white;font-size: 14px">
                                    ...
                                    <c:forEach items="${page.list}" var="song">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-sm btn-primary" modify sid="${song.sid}" type="button"> 修改 </button>

                                                <button data-toggle="button" class="btn btn-sm btn-warning" sid="${song.sid}"> 删除 </button>
                                            </td>
                                        </tr>
                                    </c:forEach>
