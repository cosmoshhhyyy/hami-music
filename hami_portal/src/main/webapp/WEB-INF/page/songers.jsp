    ...
    <script>
        $(function () {
            ...
            function loadMore01() {
                ...
                window.location.href = "/songer/dofindAll?tid="+tid+"&isHot="+isHot+"&pageSize="+pageSize+"&pageNoPortal="+pageNoPortal;
            }
        })
    </script>
            ...
            <div class="wrapper">
                <table>
                    <tr>
                        ...
                        <td class="subnav">
                            <a class="bigtext first current" href="/song/dofindAll">歌曲</a>
